    ...
    internal class DamageLib
    {
        ...
        public static float QCalc(Obj_AI_Base target)
        {
            return _Player.CalculateDamageOnUnit(target, DamageType.Magical,
                (float)(new[] { 0, 80, 120, 160, 200, 240 }[Program.Q.Level] + 0.6 * _Player.FlatMagicDamageMod
                    ));
        }
        ...
        {
            return _Player.CalculateDamageOnUnit(target, DamageType.Magical,
                (float)(new[] { 0, 20, 50, 80, 110, 140 }[Program.W.Level] + 0.3 * _Player.FlatMagicDamageMod + 0.08 * target.HealthPercent
                    ));
        }
        ...
        {
            return _Player.CalculateDamageOnUnit(target, DamageType.Magical,
                (float)(new[] { 0, 80, 130, 180, 230, 280 }[Program.E.Level] + 0.6 * _Player.FlatMagicDamageMod
                    ));
        }
        ...
        {
            return _Player.CalculateDamageOnUnit(target, DamageType.Magical,
                (float)(new[] { 0, 200, 300, 400 }[Program.R.Level]  + 0.8 * _Player.FlatMagicDamageMod
                    ));
        }
